    ...
    return (
        <>
            ...
            <main className={styles.main}>
                <div>
                    <section>
                        <Card thumbnail={'/img/about/mobile/image-about-hero.jpg'}
                              title={'About Us'}
                    ...
                    <section>
                        <Card variant={'secondary'}
                              thumbnail={'/img/about/mobile/image-world-class-talent.jpg'}
                ...
                <section>
                    <Card variant={'secondary'}
                          thumbnail={'/img/about/mobile/image-real-deal.jpg'}
                          title={'The real deal'}
